...
//
//  Created by Nathan Greene on 2/3/19.
...
class BaseGraphController: UIViewController, ChartViewDelegate {
...
extension BaseGraphController: UITableViewDelegate, UITableViewDataSource {
